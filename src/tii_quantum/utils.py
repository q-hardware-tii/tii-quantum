...
from .exceptions import ApiError, MalformedResponseError
...
def _request_and_status_check(request_fn, *args, **kwargs) -> requests.Response:
    ...
    fails, creates an ApiError with appropriate context including method,
    ...
    Raises:
        ApiError: If the response status is not OK or network error occurs
    """
    try:

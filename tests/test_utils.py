...
from tii_quantum import exceptions, utils
...
def test_post_request_with_200_output():
    ...
    response = utils.ApiRequest.post(
...
def test_post_request_with_404_error():
    ...
    with pytest.raises(exceptions.ApiError) as err:
        utils.ApiRequest.post(endpoint)
